...
class DreamConfig(Base):
    ...
    enabled: bool = True  # Master switch for Dream runs (cron and /dream)
...
class ProvidersConfig(Base):
    ...
    anthropic_claude_code: ProviderConfig = Field(default_factory=ProviderConfig, exclude=True)  # Anthropic Claude Code (OAuth)
